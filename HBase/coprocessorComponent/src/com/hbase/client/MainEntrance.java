...
public class MainEntrance {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            JSONObject json = timeSeriesSumBySingleRegion("NYCtaxi1", 
            		"15:236013312 15:236013315", "2 3 5",
            		"2015-01-01", "2015-03-20");

            JSONObject json = spatialSumBySingleRegion("NYCtaxi1",
            		"15:236012899", "2 5", "2015-01-01","2015-06-01");
    ...
    public JSONObject spatialSumBySingleRegion(String tableName, String rowkey,
    		String catelist, String starttime, String endtime) throws IOException {
    ...
    public JSONObject timeSeriesSumBySingleRegion(String tabName, String rkArray,
    		String catelist, String starttime, String endtime) throws IOException {
    	...
    	try {
	    	...
	    	Set<String> key_arr =  map.keySet();
	    	JSONObject day_of_week = new JSONObject();
	    	JSONObject time_series = new JSONObject();
	    	for (String key : key_arr)
	    	{
	    		if (key.length() != 1) {
	    			time_series.put(String.valueOf(key), map.get(String.valueOf(key)));
				}
	    		else
	    			day_of_week.put(String.valueOf(key), map.get(String.valueOf(key)));
	    	}
		
	    	result.put("time_series", time_series);
